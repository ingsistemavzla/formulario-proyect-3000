      ...
      <div className="bg-gradient-to-r from-primary-800 to-primary-700 text-white rounded-b-2xl p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-sm opacity-90 mb-2">
            Esta cotización es válida como documento técnico-profesional según estándares
            internacionales de consultoría TI.
          </p>
          <p className="text-xs opacity-80">
            Página 1 de 1 | Emisión: {emissionDate} | Referencia: {reference} | Validez: 7 días hábiles
          </p>
        </div>
      </div>
    </div>
